...
public class H2Connection {
    ...
    private final static String DB_URL = "jdbc:h2:./cuentas";
    ...
    public static void crearTablas() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:./cuentas;INIT=RUNSCRIPT FROM 'create.sql'", "sa", "sa");        } catch (Exception e) {
            e.printStackTrace();
